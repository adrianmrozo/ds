...
Regarding the task: "Choose an appropriate metric to optimize your model". The most straightforward metric was the "accuracy" with which our trained models is able to predit a category (1 out of 10) if a picture is shown to it. I cannot think of any other metric that would make sense in this context, how measure the performance of our model.
